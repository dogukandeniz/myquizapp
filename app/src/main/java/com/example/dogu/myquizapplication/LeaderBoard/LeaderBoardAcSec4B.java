package com.example.dogu.myquizapplication.LeaderBoard;
...
import com.example.dogu.myquizapplication.Adapter.LeaderBoardSec4B;
...
public class LeaderBoardAcSec4B extends AppCompatActivity {
    ...
    private LeaderBoardSec4B leaderBoardAdapterSec1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leader_board_ac_sec4_b);
    ...
    private void setUserRecyclerView() {
        leaderBoardAdapterSec1 = new LeaderBoardSec4B(this, new ArrayList<UserModel>());
