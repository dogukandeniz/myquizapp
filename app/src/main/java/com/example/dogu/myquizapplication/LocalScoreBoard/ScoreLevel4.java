...
import com.example.dogu.myquizapplication.LeaderBoard.LeaderBoardAcSec4B;
...
public class ScoreLevel4  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_score_level4);
        setTitle("Mühendislik Skoru");
        ...
        beginner.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i= new Intent(getApplicationContext(),LeaderBoardAcSec4B.class);
                startActivity(i);
